...
NAME_SUFFIX = " | StarvellBot"

MENU_COMMANDS: list[BotCommand] = [
    BotCommand(command="start", description="Главное меню"),
    BotCommand(command="logs", description="Скачать лог-файл"),
...
async def setup_bot_name(bot: Bot) -> None:
    try:
        ...
        if len(new_name) > 64:
            new_name = new_name[: 64 - len("StarvellBot")] + "StarvellBot"
