...
_LEVEL_COLORS = {_logging.DEBUG: BLUE, _logging.INFO: GREEN, _logging.WARNING: YELLOW, _logging.ERROR: RED, _logging.CRITICAL: MAGENTA}
...
def log_block(logger: _logging.Logger, level: int, title: str, lines: list[str], frame_color: str=BLUE) -> None:
